...
public class EgovUserDetailsHelper {
    ...
    public static Object getAuthenticatedUserPortal() {
        return egovUserDetailsService.getAuthenticatedUserPortal();
    }
     ...
     * @return Boolean - 인증된 사용자 여부(TRUE / FALSE)
     */
    public static Boolean isAuthenticatedPortal() {

        return egovUserDetailsService.isAuthenticatedPortal();
    }
}
