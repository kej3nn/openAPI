...
public class JsonView extends AbstractView {
    ...
    protected void renderMergedOutputModel(Map<String, Object> model,
        ...
        try {
            ...
            if (model.get("CALLBACK") != null) {
                String callBack = String.valueOf(model.get("CALLBACK"));
                model.remove("CALLBACK");
                String value = objectMapper.writeValueAsString(filterModel(model));
                ...
                JsonGenerator generator =
                        objectMapper.getJsonFactory().createJsonGenerator(response.getOutputStream());
                if (prefixJson) {
                    generator.writeRaw("{} && ");
                }
    ...
    protected Object filterModel(Map<String, Object> model) {
        LinkedHashMap<String, Object> result = new LinkedHashMap<String, Object>(model.size());
