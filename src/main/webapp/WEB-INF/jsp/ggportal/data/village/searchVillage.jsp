...
<script type="text/javascript" src="<c:url value="/js/ggportal/data/village/searchVillage.js" />"></script>
</head>
<body>
<!-- layout_A -->
<div class="layout_A">
...
<div class="layout_flex">
	...
	<div id="content" class="content">
		...
		<div class="area_regionDataSearch">
		<!-- 지역 선택 -->
		<section class="section_map_search mq_tablet">
			<h4 class="ty_A">지역 선택</h4>
			<div class="area_map_search"><div class="map_search">
			<!-- 지도 -->
			<div class="map_Gyeonggido">
				<p class="map_blank"><img src="<c:url value="/img/ggportal/desktop/data/map_blank.png"/>" usemap="#Map"  alt="" /></p>
				<p class="map_origin"><img src="<c:url value="/img/ggportal/desktop/data/map.png"/>" alt="가평,고양,과천,광명,광주,구리,군포,김포,남양주,동두천,부천,성남,수원,시흥,안산,안성,안양,양주,양평,여주,연천,오산,용인,의왕,의정부,이천,파주,평택,포천,하남,화성" /></p>
				...
				<map name="Map" id="city_map">
					...
					<area orgNm="화성시" shape="poly" coords="128,421,113,409,95,414,65,414,42,423,11,423,25,440,3,486,35,513,77,512,113,488,139,462,170,460,187,467,212,468,216,452,209,445,195,444,171,449,134,438,128,421" href="#none" onMouseOver="ovr_select_map('select_map_31');" onmouseout="out_select_map('select_map_31');" alt="화성"/>
		...
		<!-- // 지역 선택 -->
		<!-- 시/군/구 선택 -->
		<section class="section_region_search mq_mobile">
			<h4 class="ty_A">시/군 선택</h4>
			<fieldset>
			<legend>시/군/구 선택</legend>
			<select class="mq_mobile" id="city_list_mob" title="시군 선택">
