...
<script type="text/javascript" src="<c:url value="/js/ggportal/myPage/utilGallery/updateUtilGallery.js" />"></script>
</head>
<body>
<!-- layout_A -->
<div class="layout_A">
...
<div class="layout_flex">
    ...
    <div id="content" class="content">
		...
		<form id="gallery-update-form" name="gallery-update-form" method="post" enctype="multipart/form-data">
		<input type="hidden" name="bbsCd" class="bbsCd" />
        <input type="hidden" name="seq" class="seq" />
		<fieldset>
		<legend>활용 사례 수정</legend>
		<section>
            <h4 class="ty_A mgTm10_mq_mobile">활용 사례 수정</h4>
			<table class="table_datail_AB w_1">
			<caption>활용 사례 수정</caption>
			<tbody>
            <tr>
				<th scope="row">활용 구분</th>
				<td class="ty_AB ty_B">
			...
			<tr>
	           <th scope="row"><label for="writer"><span class="text_require">* </span>제작자명</label></th>
				...
				<td class="ty_AB ty_B">
					<input type="text" id="writer" class="f_110px" autocomplete="on" name="userNm"/>
				</td>
			</tr>
<!-- 			<tr>
			...
			<tr>
				...
				<td class="ty_AB ty_B">
					<input type="text" id="title" class="f_100per" autocomplete="on" name="bbsTit"/>
				</td>
			</tr>
			<tr>
			...
			<!-- <tr>
				<th scope="row"><label for="mainImg"><span class="text_require">* </span>대표이미지</label></th>
				<td class="ty_AB ty_B">
					<ul class="file_B">
					<li>	
						<input type="file" name="mainImg" id="mainImg" class="f_65per f_80per" title="대표이미지 첨부파일" />
						<span class="desc">이미지 사이즈 : 180 X 180(pixel)</span>
					</li>
					</ul>
                    <ul id="gallery-mainattach-list" class="list_file"></ul>
				</td>
			</tr> -->
			<tr>
				<th scope="row"><label><span class="text_require">* </span>화면 예시</label></th>
				<td class="ty_AB ty_B">
					<ul class="file_B <c:out value="${data.extLimit}" />" id="examImgList">
					<li>
                    ...
                    <ul id="gallery-attach-list" class="list_file"></ul>
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="text_require">* </span>연결</th>
				<td class="ty_AB ty_B">
					<ul class="file_B file_BB" id="linkUrlList">
					<li>	
						<div class="area_form area_connect">
							<div>
								<span for="aaa">연결명</span>
								<input type="text" id="aaa" name="linkNm">
							</div>
							<div>
		...
		<div class="area_btn_A">
			...
			<a id="gallery-update-button" href="#" class="btn_A">수정</a>
        ...
        <form id="gallery-search-form" name="gallery-search-form" method="post">
            ...
            <input type="hidden" name="secretYn" value="<c:out value="${param.secretYn}" default="" />" />
        </form>
    </div>
    <!-- // content -->
</div>
