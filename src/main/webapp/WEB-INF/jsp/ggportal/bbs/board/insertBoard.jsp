...
<%-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ --%>
<%-- @(#)insertBoard.jsp 1.0 2015/06/15                                     --%>
<%--                                                                        --%>
...
<script type="text/javascript" src="<c:url value="/js/ggportal/bbs/board/insertBoard.js" />"></script>
</head>
<body>
<!-- layout_A -->
<div class="layout_A">
...
<div class="layout_flex">
    ...
    <div id="content" class="content">
        ...
        <form id="board-insert-form" name="board-insert-form" method="post" enctype="multipart/form-data">
        <%--
        <fieldset>
        ...
        <div class="area_btn_A">
            ...
            <a id="board-insert-button" href="#" class="btn_A">저장</a>
