...
<script type="text/javascript" src="<c:url value="/js/ggportal/bbs/qna/insertQna.js" />"></script>
</head>
<body>
<!-- layout_A -->
<div class="layout_A">
...
<div class="layout_flex">
    ...
    <div id="content" class="content">
        ...
        <section>
            ...
            <tr>
                <th scope="row"><label for="bbsCont">내용</label></th>
                <td class="ty_AB ty_B">
                    <c:choose>
                    <c:when test="${data.htmlYn == 'Y'}">
                    <textarea id="bbsCont" name="bbsCont" class="bbsCont html" style="ime-mode:active;"></textarea>
                    </c:when>
                    <c:otherwise>
                    <textarea id="bbsCont" name="bbsCont" class="bbsCont" style="ime-mode:active;"></textarea>
                    </c:otherwise>
                    </c:choose>
                </td>
            </tr>
            ...
            <tr>
                <th scope="row"><label for="bulletIdInfo">비밀번호</label></th>
                <td class="ty_AB ty_B">
                    <input type="password" id="bulletIdInfo" name="bulletIdInfo" autocomplete="on" class="pwd f_110px" style="ime-mode:disabled;" />
                </td>
            </tr>
            </c:if>
            ...
            <tr>
                <th scope="row"><label for="qna-upload-list">파일첨부</label></th>
                <td class="ty_AB ty_B">
