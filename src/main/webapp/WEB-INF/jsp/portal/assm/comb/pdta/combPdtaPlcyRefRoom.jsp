...
<form id="prrForm" method="post">
	...
	<div class="press_intreview" id="prr-result-sect">
	</div>
	<div id="prr-pager-sect"></div>
</form>
<script type="text/javascript" src="<c:url value="/js/portal/assm/comb/pdta/combPdtaPlcyRefRoom.js" />"></script>