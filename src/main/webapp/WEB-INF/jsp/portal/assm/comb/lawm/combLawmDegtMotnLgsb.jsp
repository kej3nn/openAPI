...
<form id="degtForm" method="post">
	...
	<input type="hidden" name="gubunId" value="AD_2" title="구분코드">
...
<script type="text/javascript" src="<c:url value="/js/portal/assm/comb/lawm/combLawmDegtMotnLgsb.js" />"></script>