...
$(function() {
	...
	if ( GC_ISMOBILE ) {
	 	$("#ifm").attr("src", "/portal/assm/memberInfoPage.do?monaCd=${monaCd}");
	}
});
</script>
</head>
<body style="margin:0px;padding:0px;overflow:hidden">
    <iframe title="국회의원 소개 | 열린국회정보" src="/portal/assm/memberPage.do?monaCd=${monaCd}" id="ifm" frameborder="0" style="overflow:hidden;overflow-x:hidden;overflow-y:hidden;height:100%;width:100%;position:absolute;top:0px;left:0px;right:0px;bottom:0px"></iframe>
</body>
</body>
</html>