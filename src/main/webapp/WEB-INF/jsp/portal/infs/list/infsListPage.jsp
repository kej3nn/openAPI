							...
							<div class="wrap_layout_flex fix_page">
								<div class="layout_easySearch layout_flex_100">
									...
									<div class="toplevel_tab">
										<ul>
											<li><a href="/portal/infs/cont/infsContPage.do" aria-selected="false">정보공개 콘텐츠</a></li>
											<li><a href="javascript:;" class="on" aria-selected="true" title="선택됨">정보공개 목록</a></li>
										</ul>
									</div>
									<!-- //top level TAB -->
										...
										<div class="mca_header">
											...
											<div>
												...
												<ul class="bn_list">
													...
													<li><a href="javascript:;" id="btnMbTagIdO" data-gubun="O">데이터</a></li>
													<li><a href="javascript:;" id="btnMbTagIdS" data-gubun="S">통계</a></li>
												</ul>
											</div>
										</div>
										<!-- //상단 검색 -->
									...
									<div id="search-sect">
										...
										<div class="list_group">
											<ul class="group01">
												...
												<li><button id="btnCateAll" data-gubun="A" class="on" aria-selected="true" title="선택됨">전체</button></li>
										...
										<div class="list_group">
											<ul class="group03">
												...
												<li><button id="btnSrvAll" data-gubun="ALL" class="on" aria-selected="true" title="선택됨">전체</button></li>
												<li><button id="btnSrvIdS" data-gubun="S" aria-selected="false">표</button></li>
												<li><button id="btnSrvIdC" data-gubun="C" aria-selected="false">차트</button></li>
												<li><button id="btnSrvIdO" data-gubun="A" aria-selected="false">API</button></li>
												<li><button id="btnSrvIdF" data-gubun="F" aria-selected="false">파일</button></li>
												<li><button id="btnSrvIdL" data-gubun="L" aria-selected="false">링크</button></li>
											</ul>
										</div>
										<div class="list_group">
											<ul class="group04">
												<li><strong>공개유형</strong></li>
												<li><button id="btnTagAll" data-gubun="A" class="on" aria-selected="true" title="선택됨">전체</button></li>
												<li><button id="btnTagIdD" data-gubun="D" aria-selected="false">규정(지침)</button></li>
												<li><button id="btnTagIdO" data-gubun="O" aria-selected="false">데이터</button></li>
												<li><button id="btnTagIdS" data-gubun="S" aria-selected="false">통계</button></li>
											</ul>
											<ul class="group05">
									...
									<div id="result-sect">
										...
										<div class="result_view">
											<ul>
												...
												<li><button id="btnVOrderDate" 	data-gubun="D" class="${schParams.schVOrder == 'D' ? 'on' : '' }" title="선택됨">공개일자순</button></li>
...
<script type="text/javascript" src="<c:url value="/js/portal/infs/list/infsList.js" />"></script>
<script type="text/javascript" src="<c:url value="/js/portal/infs/list/infsListEvent.js" />"></script>
</body>
</html>