...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<div class="easySearch">
		...
		<input type="hidden" name="statTitle" title="statTitle" value="${meta.statblNm } "/>
		...
		<input type="hidden" name="callStatType" id="callStatType" title="callStatType" value="${callStatType }" />
		<!-- areaDv -->
		<div class="areaDv">
			<!-- areaDetail -->
			<div class="areaDetail">
				...
				<div class="schTit c003399">
					...
					<div class="right btpd">
						<button class="btnSt1 btn6 meta" type="button" name="metaData" title="메타데이터"><spring:message code='stat.ko.message.165'/></button>						
						<button class="btnSt1 btn3 wHide" type="button" name="easyClose" title="닫기"><spring:message code='stat.ko.message.192'/></button>
					</div>
				</div>
				 -->
				<!-- metaData -->
				...
				<div class="viewBx pr">
							...
							<div class="cellbox">
								<div class="cell" id="Ncell">
									<span class="set">
										...
										<select name="dtacycleCd" id="dtacycleCd" title="검색구분선택"><option value="">월</option></select>
									</span>
									<span class="set">
										<span class="cellbox2">
											<span class="cell2 tt1 wHide">검색기간</span>
											<span class="cell2 auto">
												<input type="radio" name="wrttimeType" id="wrttimeType" value="B" title="기간검색"/>
												<span class="yearSet">
													<span class="line">
														<select name="wrttimeStartYear" id="wrttimeStartYear" title="시작년도선택"></select>
														<select name="wrttimeStartQt" id="wrttimeStartQt" style="display: none;" title="시작월(분기)선택"></select>
														<span class="wHide">부터</span>
														<span class="slash mHide" id="labelFor07">~</span>
													</span>
													<span class="line">
														<select name="wrttimeEndYear" id="wrttimeEndYear" title="종료년도선택"></select>
														<select name="wrttimeEndQt" id="wrttimeEndQt" style="display: none;" title="종료월(분기)선택"></select>
									...
									<span class="set">
										...
										<span>
											<input type="radio" id="wrttimeType" name="wrttimeType" value="L" title="최근시점기준"/>
									...
									<span class="set">
										<span>
											...
											<select name="wrttimeOrder" id="wrttimeOrder" title="정렬">
									...
									<span class="set onlysel">
										<span>
											<select name="uiChgVal" id="uiChgVal" title="단위선택"></select>
										</span>	
										<span>
											<select name="dmPointVal" id="dmPointVal" title="소숫점선택"></select>
										</span>
									</span>
					...
					<div class="tabBx">
						...
						<div class="tabSt with3tab">
							...
							<div class="header_fixed" style="right: 3px;">
						...
						<div class="tabCont sheetTab">
							...
							<div class="sheetarea">
								...
								<div class="ibsheet_area" style="clear: both; overflow:auto;">
									<div class="grid statEasySheet">
										<script type="text/javascript">createIBSheet("statSheet", "100%", "500px"); </script>
									</div>
								</div>
							</div>
							<!-- // sheet -->
						...
						<div class="tabCont chartTab" style="display:none">
							...
							<div class="chartarea">
								...
								<div class="chartDv">
									<div class="chart statEasyChart" id="statChart"></div>
								</div>
								<div id="sliderArea" style="height: 100px; overflow: hidden">
									<div class="statSlider" id="statSlider"></div>
								</div>
							</div>
							<!-- /// chartarea -->
						</div>
	...
	<div class="area_btn_A">
		<%-- <c:set var="isInfsPop" value="${param.isInfsPop}" ></c:set> --%>
    	<c:choose>
        <c:when test="${isInfsPop eq 'Y' }">
        	<a href="#" class="btn_A" onclick="javascript: window.close();">목록</a>
        </c:when>
        <c:otherwise>
        	<a href="javascript:moveInfsList();" class="btn_A">목록</a>
        </c:otherwise>
        </c:choose>
  	</div>
  	<!-- //목록 -->
