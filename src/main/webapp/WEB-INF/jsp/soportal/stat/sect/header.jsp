...
<div class="detail_summary">
	...
	<div class="summary">
		<strong class="tit">${meta.statblNm }</strong>
	    <span class="opentyTagNm ot01">통계</span>
	    <div>${meta.statblCmmt }</div>
		<div class="area_grade clfix">
            ...
            <a href="javascript:;" class="toggle_metaInfo"><strong>메타 정보 열기</strong>
            	<img src="/images/toggle_open_metaInfo.png" alt="">
            </a>
            <div class="btn_sns">
...
function insertApprVal() {
    // 데이터를 처리한다.
    doPost({
        url:"/portal/stat/insertSttsTblAppr.do",
...
function beforeInsertApprVal(options) {
    var data = {
    	statblId: $("input[name=statblId]").val(),
