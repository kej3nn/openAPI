...
<!-- 사칙연산  js추가  -->
<script type="text/javascript" src="<c:url value="/js/soportal/stat/fCalcStatSch.js" />"></script>
...
<!-- jquery alphanum -->
<script type="text/javascript" src="<c:url value="/js/jquery/jquery.alphanum.js" />"></script>
			...
			<div class="easySearchArea" id="tabs">
				...
				<div class="searchTab" id="searchTab">
					<ul class="tabTitle" id="statTabArea">
						<li class="all"><a href="javascript:;" id="tab_title"><span>사칙연산</span></a></li>
					</ul>
				</div>
				<!-- // searchTab -->
				<c:import  url="fCalcStatSchTab.jsp"/>
							...
							<div class="rSide">
								...
								<div class="box2">
									...
									<div class="searchCtrl multi_ctrl">
										...
										<div class="searchTbl">
										<!-- table -->
											<div id='mixContainer' class="calcul"></div>
										<!-- //table -->
										</div>
										<!-- // reportTable -->
										...
										<div class="calculator">
											<div class="calcu01">
												<label for="calcAqnNm">지표명</label>
												<div>
													<input type="text" value="" id="calcAqnNm" name="calcAqnNm" maxlength="30">
												</div>
											</div>
											<div class="calcu02">
												<strong>계산식</strong>
												<div class="calcu_func">
													<span>기호(A-Z), +, -, *, /, (, ), 숫자</span>
													<a href="javascript:;" class="btnSt1 btn7 reset" id="calcAqnReset">초기화</a>
												</div>
											</div>
											<div class="calcu03">
												<input type="text" value="" id="calcAqn" name="calcAqn" class="calcu_input">
												<p>
													<label for="dtaCalcNullToZero">
