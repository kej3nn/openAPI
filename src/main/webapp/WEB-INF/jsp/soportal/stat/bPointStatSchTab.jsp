			...
			<div class="areaDetail">
				...
				<div class="viewBx pr">
					<div class="schBtnTglDv">
						<!-- searchBx -->
						<div class="searchBx fCal">
							<div class="cellbox">
								<div class="cell" id="Ncell">
									<span class="set">
										<span class="tt1 wHide"><spring:message code='stat.ko.message.193'/></span>
										<select name="dtacycleCd" id="dtacycleCd" title="검색구분선택"><option value=""><spring:message code='stat.ko.message.123'/></option></select>
									</span>
									<span class="set">
										<span class="cellbox2">
						...
						<div class="calculator_tab">
							<div>
								<span class="calt01"><label for="jipyo">기준시점</label></span>
								<div class="calt02s cl49s">
									<div>		
										<select id="dtaWrttimeYear" name="dtaWrttimeYear"></select>
										<select id="dtaWrttimeQt" name="dtaWrttimeQt"></select>
									</div>
									<label for="dtaCalcNullToZero" class="calt03">
										<input type="checkbox" id="dtaCalcNullToZero" name="dtaCalcNullToZero" value="Y"> NULL값은 0으로 계산
									</label>
								</div>
							</div>
						</div>
					...
					<div class="tabBx">
						...
						<div class="tabSt with3tab">
							<ul>
								<li class="on"><a href="#sheetTab" title="Sheet">Sheet</a></li>
								<li><a href="#chartTab" title="Chart">Chart</a></li>
