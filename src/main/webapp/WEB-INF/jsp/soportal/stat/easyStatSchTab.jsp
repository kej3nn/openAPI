			...
			<div class="areaDetail">
				<div class="schTit c003399">
					...
					<div class="right btpd">
					    <button class="btnSt1 btnX" type="button" name="statNaboeS" title="통계해설">통계해설</button>
					    <button class="btnSt1 btnX" type="button" name="statNaborS" title="통계설명">통계설명</button>
					    <button class="btnSt1 btnX" type="button" name="statNabooS" title="국회부대의견">국회부대의견</button>
					    <button class="btnSt1 btnX" type="button" name="statNabocS" title="시정조치">시정조치</button>
					   <!--  <button class="btnSt1 btnX" type="button" name="statSttsqa" title="질의/답변">질의/답변</button> -->
					    <button class="btnSt1 btn82" type="button" name="statDicS" title="용어설명">용어설명</button>
						<button class="btnSt1 btn8" type="button" name="btnStatHist" style="display: none;" title="통계이력"><spring:message code='stat.ko.message.191'/></button>
						<c:choose>
