...
<!-- 간편통계용  js추가  -->
<script type="text/javascript" src="<c:url value="/js/soportal/stat/easyStatSch3.js" />"></script>
<script type="text/javascript" src="<c:url value="/js/soportal/stat/easyStatSchSearch3.js" />"></script>
<script type="text/javascript" src="<c:url value="/js/soportal/stat/easyStatSchTree3.js" />"></script>
<script type="text/javascript" src="<c:url value="/js/soportal/stat/easyStatSchEvent3.js" />"></script>
<script type="text/javascript" src="<c:url value="/js/soportal/stat/easyStatSchContents2.js" />"></script>
	...
	<article>
		<div class="contents" id="contents">
			...
			<div class="easySearchArea" id="tabs">
				...
				<c:import  url="easyStatSchTab2.jsp"/>
