...
<script type="text/javascript" src="<c:url value="/js/soportal/expose/zpno.js" />"></script>
<style>
	...
	<body>
		...
		<div id="pop_wrapper">
            ...
            <div class="pop_content"> 
                ...
                <!-- pop_tab -->
                <ul class="pop_tab">
                	<li class="on"><a href="roadSearchAddress.html">도로명주소</a></li>
                    <li><a href="searchAddress.html">지번주소</a></li>
                </ul>
                <!-- //pop_tab -->
				...
				<div id="result_data_page" style="height: 18px;display: none;">
                </div>
            </div>
            <!-- //pop_content -->
        </div>
