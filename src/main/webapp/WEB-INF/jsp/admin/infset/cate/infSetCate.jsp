...
<script type="text/javascript" src="<c:url value="/js/admin/infset/cate/infSetCate.js" />"></script>
...
<body onload="">
	<div class="wrap">
		...
		<div class="container">
			...
			<c:import  url="infSetCateDtl.jsp"/>
			
			<!-- 리스트 -->
			<div class="content">
				<form name="infSetMainForm"  method="post" action="#">
				<table class="list01">
