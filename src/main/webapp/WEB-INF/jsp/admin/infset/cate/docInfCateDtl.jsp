...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<div class="content" id="docInfInputDtl" style="clear: both; display: none;">
		<form id="docInfCate-dtl-form" name="docInfCate-dtl-form" method="post" action="#">
			...
			<table class="list01" style="position: relative;">
				...
				<tr>
					...
					<td colspan="2">
						...
						<button type="button" class="btn01" id="docInfCate_dup" name="docInfCate_dup">중복확인</button>
					</td>
					<td>※ 영문, 숫자 10자리 이내</td>
				</tr>
				<tr>
					...
					<td colspan="3">
						...
						<input type="text" id="cateNmEng" name="cateNmEng" size="30" placeholder="(영문) 입력하세요." />
					</td>
				</tr>
				<tr>
					<th>상위그룹</th>
					<td colspan="2">
						...
						<button type="button" class="btn01" id="docInfCate_pop" name="docInfCate_pop">검색</button>
						<button type="button" class="btn01" id="docInfCate_init" name="docInfCate_init">상위 초기화</button>
					</td>
