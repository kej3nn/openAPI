...
function doAction(sAction) {
	...
	switch(sAction) {
		case "search":      //조회   
			...
			sheet.DoSearchPaging(com.wise.help.url("/admin/infs/cate/infSetCatePopList.do"), param);
			break;
	}
}
...
function sheet_OnDblClick(row, col, value, cellx, celly) {
    ...
    arrayValue = {
    		parCateId : sheet.GetCellValue(row, "cateId"), 
    		parCateNm : sheet.GetCellValue(row, "cateNm"),
    		//topCateId : sheet.GetCellValue(topRow, "cateId")
