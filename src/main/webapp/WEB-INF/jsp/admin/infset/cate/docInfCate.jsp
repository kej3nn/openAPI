...
<script type="text/javascript" src="<c:url value="/js/admin/infset/cate/docInfCate.js" />"></script>
...
<body onload="">
	<div class="wrap">
		...
		<div class="container">
			...
			<c:import  url="docInfCateDtl.jsp"/>
			
			<!-- 리스트 -->
			<div class="content">
				<form name="docInfMainForm"  method="post" action="#">
				<table class="list01">
					<caption>문서분류 리스트</caption>
					<colgroup>
						<col width="20%"/>
						<col width="80%"/>
					</colgroup>
