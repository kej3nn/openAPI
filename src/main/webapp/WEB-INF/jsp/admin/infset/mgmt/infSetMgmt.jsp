...
<body onload="">
	<div class="wrap">
		...
		<div class="container">
			...
			<c:import  url="infSetMgmtMst.jsp"/>
					...
					<tr>
						...
						<td>
							<select name="openType">
								...
								<option value="O">공공</option>
								<option value="S">통계</option>
							</select>
						</td>
						<th>공개일</th>
						<td>
					...
					<tr>
						...
						<td colspan="3">
							<select id="searchGubun" name="searchGubun">
								<option value="INFS_NM">정보셋 명</option>
								<option value="INFS_ID">정보셋 ID</option>
							</select>
...
<script type="text/javascript" src="<c:url value="/js/admin/infset/mgmt/infSetMgmt.js" />"></script>
<script type="text/javascript" src="<c:url value="/js/admin/infset/mgmt/infSetMgmtSheet.js" />"></script>
<script type="text/javascript" src="<c:url value="/js/admin/infset/mgmt/infSetMgmtEvent.js" />"></script>
</html>