...
<div name="tab-inner-doc-sect" class="tab-inner-sect" style="display: none;">
				...
				<div style="width: 100%; float: left;">
					<div class="ibsheet-header">
						...
						<div class="header-right-btn">
							<button type="button" class="btn01" name="docAdd" >추가</button>
						</div>
					</div>
	...
	<div class="buttons">
		<a href='javascript:;' class='btn02'  title="위로이동" name="a_doc_up">위로이동</a>
		<a href='javascript:;' class='btn02'  title="아래로이동" name="a_doc_down">아래로이동</a>
