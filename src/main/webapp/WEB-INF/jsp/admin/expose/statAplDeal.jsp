...
<script type="text/javascript" src="<c:url value="/js/admin/expose/statAplDeal.js" />"></script>
</head>     
<body onload="">
<div class="wrap">
	...
	<div class="container">
		...
		<div class="title">
			...
			<!-- 목록내용 -->
		<div class="content">
			<form name="aplDealForm"  method="post" action="#">
				<input type="hidden" name="opbYnp" value="" />
				<input type="hidden" name="prg" value="" />
				<input type="hidden" name="trsf" value="" />
