...
<script type="text/javascript" src="<c:url value="/js/admin/expose/statObjtnDeal.js" />"></script>
</head>     
<body onload="">
<div class="wrap">
	...
	<div class="container">
		...
		<!-- 목록내용 -->
		<div class="content">
			<form name="ObjtnDealForm"  method="post" action="#">
				<input type="hidden" name="objtn" value="" />
