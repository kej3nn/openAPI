...
<script type="text/javascript" src="<c:url value="/js/admin/expose/statAplDcsDt.js" />"></script>
</head>     
<body onload="">
<div class="wrap">
