...
<script type="text/javascript" src="<c:url value="/js/admin/expose/statClsdRson.js" />"></script>
</head>     
<body onload="">
<div class="wrap">
	...
	<div class="container">
		...
		<div class="title">
			...
			<!-- 목록내용 -->
		<div class="content">
			<form name="clsdRsonForm"  method="post" action="#">
				<input type="hidden" name="aplDealInstCd" value="" />
				<input type="hidden" name="clsdRsonCd" value="" />
