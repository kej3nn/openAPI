...
<script type="text/javascript" src="<c:url value="/js/admin/expose/acsOpnzDel.js" />"></script>
</head>
<body>
	<div class="wrap">
			...
			<div class="content">
				...
				<table class="list01">
					...
					<tr>
						<th>삭제일자</th>
						<td colspan="3">
							<input type="text" name="startDelDt" value="" placeholder="시작일자" size="13" />
							~
							<input type="text" name="endDelDt" value="" placeholder="종료일자" size="13" />
							&nbsp;&nbsp;
							<button type="button" class="btn01" id="delDt_reset" name="delDt_reset">초기화</button>
							<button type="button" class="btn01" id="aplDt_set" name="aplDt_set">청구일기준 10년 이상 자료</button>
							<button type="button" class="btn01" id="dcsNtc_set" name="dcsNtc_set">통지일기준 10년 이상 자료</button>
						</td>
					</tr>
