...
<script type="text/javascript" src="<c:url value="/js/admin/expose/statAplOpbFom.js" />"></script>
</head>     
<body onload="">
<div class="wrap">
	...
	<div class="container">
		...
		<div class="title">
			...
			<!-- 목록내용 -->
		<div class="content">
			<form name="aplOpbForm"  method="post" action="#">
				<input type="hidden" name="opbFomVAl" value="" />
				<input type="hidden" name="giveMth" value="" />
				<input type="hidden" name="opbY" value="" />
				...
				<table class="list01">              
					...
					<tr>
						...
						<td colspan="3">
							...
							<input type="hidden" name="instCd" value="${sessionScope.portalOrgCode}"/>
							</c:otherwise>
							</c:choose>	
						</td>
					</tr>	
