...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<div class="content" id="statInputDtl" style="clear: both; display: none;">
		...
		<input type="hidden" name="fileUpdateYn" value=""/>
		...
		<div name="tab-inner-dtl-sect" class="tab-inner-sect">
			...
			<h3 class="text-title2">공개결정 내용등록</h3>	
			<table class="list01" style="position: relative;">
				...
				<tr>
					...
					<td colspan="3">
						<div name="comWrite">
							<input type="text" style="width:300px;" name="dcs_ntcs_doc_no" value="국회민원지원-" maxlength="25" />
						</div>
						<div name="comDetail">
				...
				<tr id="pdfTransDiv" style="display: none;">
					<th colspan="2" scope="row">변환 처리</th>
					<td colspan="3">
						<div><input type="checkbox" name="transPdf" checked="checked" value="1"/><span> PDF</span></div>
						<div><input type="checkbox" name="transTs" checked="checked" value="1"/><span> TIMESTAMP</span></div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3">
						...
						<span class="byte_r"><input type="text" name="len1" style="width:40px;text-align:right;border: none;margin-bottom:3px;" value="0" readonly>/2,000 Byte</span>
					</td>
				</tr>
				<tr name="clsdDiv3">
					...
					<td colspan="3" name="clsdTd6">
						<div name="comWrite">
							...
							<span class="byte_r"><input type="text" name="len2" style="width:40px; text-align:right;border: none;margin-bottom:3px;" value="0" readonly>/500 Byte</span>
						</div>
						<div name="comDetail">
				...
				<tr name="clsdDiv6">
					...
					<td colspan="3" name="clsdTd62">
						<div name="comWrite">
							...
							<span class="byte_r"><input type="text" name="len3" style="width:30px; text-align:right;border: none;margin-bottom:3px;" value="0" readonly>/500 Byte</span>
							<br>
				...
				<tr name="clsdDiv1" style="display: none;">
					<th colspan="2" scope="row"><span class="text_require">* </span>비공개 (전부 또는 일부)<br> 내용 및 사유</th>
					<td colspan="3" name="clsdTd2">
						<div name="comWrite">
							<input type="hidden" id="clsdCnt" name="clsdCnt" value="1"/>
							<div name="clsdArea">
								<label name="clsd1">								
									<table class="list02" style="width:800px;">
										<colgroup>
											<col style="width:100px;">
											<col style="width:600px;">
											<col style="width:100px;">
										</colgroup>
										<tbody name="privateInfo">
											<tr>
												<td style="background:#ECEBFF;font-weight: bold;">비공개내용</td>
												<td>
													<textarea name="clsd_rmk" rows="3" cols="75" style="border-color:#5F00FF;"></textarea><br />
													<span class="byte_r"><input type="text" name="len4" style="width:30px; text-align:right;border: none;margin-bottom:3px;padding:1px;" value="0" readonly>/500 Byte</span>
												</td>
												<td rowspan="2" style="border-right-color: #FFFFFF;border-top-color: #FFFFFF;border-bottom-color: #FFFFFF;vertical-align: top;"	>
													<button type="button" class="btn02" name="clsdAdd" onclick="javascript:fn_clsdAdd();">추가</button>
												</td>
											</tr>
											<tr>
												<td style="background:#ECEBFF;font-weight: bold;">비공개사유</td>
												<td>
													<select name="clsd_rson_cd" style="border-color:#5F00FF;">
														<option value="">비공개사유를 선택하세요</option>
													</select>
													<input type="text" name="clsd_rson" size="53" value=""  style="border-color:#5F00FF;display: none;"/> 
												</td>
											</tr>
										</tbody>
									</table>
				...
				<tr name="clsdDiv2" style="display: none;">
					<th colspan="2" scope="row" name="clsdTd3">비공개 첨부</th>
					<td colspan="3" name="clsdTd4">
						<div name="comWrite">
			...
			<table class="list01" style="position: relative;">
				...
				<tr name="clsdDiv27">
					<th name="clsdTd271">특이사항</th>
					<td name="clsdTd272">
						<div name="comWrite">
							<input type="checkbox" name="imd_deal_div" value="1"/><span> 즉시처리</span>
						</div>
						<div name="comDetail">
			...
			<div class="buttons">
				...
				<div name="comDetail">
					<a href="javascript:;" class="btn02" title="파일수정" name="btnFileUpdate" style="display:none;">파일수정</a>
