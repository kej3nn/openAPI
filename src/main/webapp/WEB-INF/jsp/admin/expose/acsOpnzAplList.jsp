...
<script type="text/javascript" src="<c:url value="/js/admin/expose/acsOpnzAplList.js" />"></script>
</head>     
<body onload="">
<div class="wrap">
	...
	<div class="container">
		...
		<!-- 목록내용 -->
		<div class="content">
			<form name="acsOpnzAplForm"  method="post" action="#">
				...
				<table class="list01">              
					...
					<tr>
						...
						<th>처리구분</th>
						<td>
							<select id="acsPrssCd"  name="acsPrssCd">
							</select>
						</td>
					</tr>
					<tr>
						<th>청구인</th>
						<td><input type="text" name="aplPn" value="" placeholder="검색어 입력" size="40" /></td>
						<th>열람자명</th>
						<td><input type="text" name="userNm" value="" placeholder="검색어 입력" size="40" /></td>
					</tr>	
					<tr>
						<th>청구제목</th>
						<td><input type="text" name="aplSj" value="" placeholder="검색어 입력" size="40" /></td>	
						<th>공개일자</th>
						<td>
