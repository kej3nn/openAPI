...
function LoadPage()                
{
    ...
    with(mySheet1){
        ...
        var cols = [          
					...
					,{Type:"Text",		SaveName:"ownTabId",			Width:300,	Align:"Left",		Edit:false}
					,{Type:"Text",		SaveName:"tableName",			Width:300,	Align:"Left",		Edit:false, Hidden:true}
...
function doAction(sAction)                                  
{
	...
	{          
		case "search":      //조회   
			...
			mySheet1.DoSearchPaging("<c:url value='/admin/openinf/opends/popup/openDsPopList.do'/>", param);
			break;
...
function mySheet1_OnDblClick(row, col, value, cellx, celly) {
    ...
    var arrayValue ={dsId:mySheet1.GetCellValue(row, "tableName"), ownerCd:mySheet1.GetCellValue(row, "owner"), ownerCode:mySheet1.GetCellValue(row, "owner")}// json으로 부모창 input 이름, data
					...
					<tr>
						...
						<td colspan="5">
							<select name="owner">
		                 	...
		                 	<input type="text" name="tableName" class="input" maxlength="40"/>
