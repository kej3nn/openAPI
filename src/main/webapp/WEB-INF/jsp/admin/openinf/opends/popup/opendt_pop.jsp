...
function LoadPage()                
{
	var gridTitle = "NO"
	     ...
	     gridTitle +="|"+"<spring:message code='labal.srcExp'/>";
    ...
    with(mySheet1){
        ...
        var cols = [          
					...
					,{Type:"Text",		SaveName:"srcExp",			Width:100,	Align:"Left",		Edit:false}
                ];                                                                    
...
function doAction(sAction)                                  
{
	...
	{          
		case "search":      //조회   
			...
			mySheet1.DoSearchPaging("<c:url value='/admin/openinf/opends/popup/openDtPopList.do'/>", param);
			break;
...
function mySheet1_OnDblClick(row, col, value, cellx, celly) {
    ...
    var arrayValue ={dtId:mySheet1.GetCellValue(row, "dtId"), dtNm:mySheet1.GetCellValue(row, "dtNm")}// json으로 부모창 input 이름, data
