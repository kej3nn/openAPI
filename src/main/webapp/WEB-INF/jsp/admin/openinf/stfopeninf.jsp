...
<body onload="">
	<div class="wrap">
		...
		<c:import  url="stfopeninfDtl.jsp"/>
			
			<!-- 리스트 -->
			<div class="content">
				<form name="stfopeninfMainForm"  method="post" action="#">
				<table class="list01">
					<caption>리스트</caption>
					<colgroup>
						<col width="150"/>
					...
					<tr>
						...
						<td colspan="7">
							<select id="searchWd" name="searchWd">
...
<script type="text/javascript" src="<c:url value="/js/admin/openinf/stfopeninf.js" />"></script>
</html>