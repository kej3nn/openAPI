	...
	if(json.DATA != null){
		...
		$.each(json.DATA,function(key,state){ 
			...
			$.each(state,function(key2,state2){
				...
				if(key2 == "prssState" && state2 == "AK"){
					setPrssAccCdBtn(tab, "prssCA", prssAccCd);		//개방취소요청 버튼 show/hide
				}
				if(key2 == "prssState" && state2 == "CA"){
					setPrssAccCdBtn(tab, "prssCAca", prssAccCd);	//개방취소요청 취소 버튼 show/hide
				}
				if(key2 == "apiRes"){
					if(state2 != null){
...
function setTabButton(){		//버튼event
	...
	formObj.find("a[name=prssCA]").click(function() {		// 개방요청
 		doTabAction("prssCA");          
 		return false;                 
 	});
	
	formObj.find("a[name=prssCAca]").click(function() {		// 개방요청취소
 		doTabAction("prssCAca");          
 		return false;                 
 	});
			...
			<div class="content" style="display:none">
				...
				<table class="list01">
					...
					<tr>
						...
						<td colspan="3">
							<div style="float:left;"><input type="text" name="infNm" size="50" class="text-read" readonly/></div> 
...
<!-- 					</tr> -->
				...
				<div class="buttons">
					<a href="#" class="btn03" name="prssCA" style="display: none;">개방취소요청</a>					
					<a href="#" class="btn03L" name="prssCAca" style="display: none">개방취소요청 취소</a>
			...
			<div class="content"  >
			<form name="adminOpenInfPrss"  method="post" action="#">
			<input type="hidden" name="prssGubun" value="CA" />
