...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<div class="content" id="naSetInputDtl" style="clear: both; display: none;">
		<form id="naSetCate-dtl-form" name="naSetCate-dtl-form" method="post" action="#">
		<input type="hidden" name="cateTag" value="${cateTag}">
			...
			<table class="list01" style="position: relative;">
				...
				<tr>
					...
					<td colspan="2">
						...
						<button type="button" class="btn01" id="naSetCate_dup" name="naSetCate_dup">중복확인</button>
					</td>
					<td>※ 영문, 숫자 10자리 이내</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="2">
						...
						<button type="button" class="btn01" id="naSetCate_init" name="naSetCate_init">상위 초기화</button>
					</td>
