...
<script type="text/javascript" src="<c:url value="/js/admin/nadata/cate/naSetCate.js" />"></script>
...
<body onload="">
	<div class="wrap">
		...
		<div class="container">
			...
			<c:import  url="naSetCateDtl.jsp"/>
			
			<!-- 리스트 -->
			<div class="content">
				<form name="naSetMainForm"  method="post" action="#">
					...
					<tr>
						...
						<td colspan="3">
							<select id="searchGubun" name="searchGubun">
								...
								<option value="CATE_NM_ENG">영문분류명</option>
								<option value="CATE_ID">분류ID</option>
							</select>
