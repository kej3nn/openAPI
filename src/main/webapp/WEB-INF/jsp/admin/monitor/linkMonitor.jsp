			...
			<div class="content">
				...
				<table class="list01">
					...
					<tr>
						...
						<td>
							<select id="searchGubun" name="searchGubun">
								<option value="DB_CONN_JOB_NM">DB연계 명</option>
					...
					<tr>
						<th>시스템</th>
						<td>
							<select id="srcSysCd" name="srcSysCd">
								<option value="">선택</option>
								<c:forEach var="list" items="${srcSysCd}">
...
<script type="text/javascript" src="<c:url value="/js/admin/monitor/linkMonitor.js" />"></script>
</html>