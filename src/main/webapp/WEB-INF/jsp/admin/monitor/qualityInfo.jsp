...
function init(){
	var formObj = $("form[name=quality-monitor]:eq(0)");
...
function LoadPage() {      
    ...
    with(mySheet){    
        ...
        var cols = [          
			 		...
			 		,{Type:"Text",			SaveName:"num",					Width:50,	Align:"Center",		Edit:false,	Hidden:true}
					,{Type:"Text",			SaveName:"jobNm",					Width:50,	Align:"Center",		Edit:false}
					,{Type:"Text",			SaveName:"prfCnt",				Width:50,	Align:"Center",		Edit:false}
					,{Type:"Text",			SaveName:"anaCnt",					Width:50,	Align:"Center",		Edit:false}
					,{Type:"Text",			SaveName:"esnErCnt",					width:30,	Align:"Center",		Edit:false}
					,{Type:"Text",			SaveName:"brCnt",				width:30,	Align:"Center",		Edit:false}
					,{Type:"Text",			SaveName:"brAnaCnt",				width:30,	Align:"Center",		Edit:false}
					,{Type:"Text",			SaveName:"brErCnt",				width:30,	Align:"Center",		Edit:false}
...
function LoadSheet() {      
    ...
    with(loadSheet){    
        ...
        var cols = [          
					 {Type:"Seq",			SaveName:"Seq",						Width:30,	Align:"Center",		Edit:false}
						,{Type:"Text",			SaveName:"jobNm",				Width:100,	Align:"Center",		Edit:false,	Hidden:true}
						,{Type:"Text",			SaveName:"kindCd",					Width:50,	Align:"Center",		Edit:false}
						,{Type:"Text",			SaveName:"commDtlCdNm",				Width:50,	Align:"Center",		Edit:false}
						,{Type:"Text",			SaveName:"dbcTblKorNm",					Width:50,	Align:"Center",		Edit:false}
						,{Type:"Text",			SaveName:"tbNm",					width:100,	Align:"Center",		Edit:false}
						,{Type:"Text",			SaveName:"colNm",					width:100,	Align:"Center",		Edit:false}
						,{Type:"Text",			SaveName:"anaCnt",				width:30,	Align:"Center",		Edit:false}
						,{Type:"Text",			SaveName:"esnErCnt",				width:30,	Align:"Center",		Edit:false}
						,{Type:"Text",			SaveName:"brAnaCnt",				width:30,	Align:"Center",		Edit:false}
						,{Type:"Text",			SaveName:"brErCnt",				width:30,	Align:"Center",		Edit:false}
						,{Type:"Text",			SaveName:"startDttm",				width:30,	Align:"Center",		Edit:false}
						,{Type:"Text",			SaveName:"endDttm",				width:30,	Align:"Center",		Edit:false}
                ];
...
function mySheet_OnDblClick(row, col, value, cellx, celly) {
	...
	var num = mySheet.GetCellValue(row, "num");
	
	ajaxBeforeSendAdmin("<c:url value='/admin/ajaxBeforeSendAdmin.do'/>"); //IbSheet 조회전 세션 체크
	var param = {PageParam: "ibpage", Param: "onepagerow=50&num="+num};     
	loadSheet.DoSearchPaging("<c:url value='/admin/monitor/qualityInfoDetail.do'/>", param);
...
function doAction(sAction) {
	switch(sAction) {          
		case "search":      //조회      
			...
			var formObj = classObj.find("form[name=quality-monitor]");
		
			ajaxBeforeSendAdmin("<c:url value='/admin/ajaxBeforeSendAdmin.do'/>"); //IbSheet 조회전 세션 체크
			var param = {PageParam: "ibpage", Param: "onepagerow=50&"+formObj.serialize()};     
			mySheet.DoSearchPaging("<c:url value='/admin/monitor/qualityInfoList.do'/>", param);   
			break;
	}           
}   
</script>
...
<div class="wrap">
	...
	<div class="container">
		...
		<div class="content"> 
			<form name="quality-monitor"  method="post" action="#">
			<table class="list01">              
				<colgroup>
					<col width="150"/>
				</colgroup>
				<tr>
					<th><label class="">작업시작일</label></th>
					<td colspan="3">
			...
			<!-- 탭 내용 --> 
		<div class="content">
			<h3 class="text-title2">오류 결과 화면</h3>
