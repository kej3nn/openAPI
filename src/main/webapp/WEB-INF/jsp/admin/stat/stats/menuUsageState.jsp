...
<script type="text/javascript" src="<c:url value="/js/admin/stats/menuUsageState.js" />"></script>
</head>     
<body onload="">
<div class="wrap">
		...
		<div class="container">
			...
			<input type="hidden" name="dateGb" title="dateGb"  value=""/>
			<table class="list01">              
				...
				<div class="ibsheet_area" style="height:600px;display:none;">
