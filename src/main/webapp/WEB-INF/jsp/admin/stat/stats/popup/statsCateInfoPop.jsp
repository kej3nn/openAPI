...
function addCate() {
	...
	var objTab = parent.getTabShowObj();//탭이 oepn된 객체가져옴
	...
	var cateSheetObj = window.parent[cateInfoSheetNm]; 
	
	//var cateSheetObj = parent.getTabSheetObj("statsMgmt-mst-form", "cateInfoSheetNm");	// 부모 분류 시트
...
function doAction(sAction) {
	...
	switch(sAction) {
		case "search" :
			...
			doAjax({
				url: "/admin/stat/popup/selectStatCateInfoPop.do",
