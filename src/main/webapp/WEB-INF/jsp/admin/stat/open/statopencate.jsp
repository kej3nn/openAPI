...
{      
    ...
    with(mySheet){
    	...
    	var cfg = {SearchMode:3,Page:50,VScrollMode:1,MergeSheet:msPrevColumnMerge};
        SetConfig(cfg);  
        var headers = [                                             
...
function doAction(sAction)                                  
{
	...
	{          
		case "search":      //조회
			...
			mySheet.DoSearchPaging("<c:url value='/admin/stat/open/getOpenStatCateSheetAll.do'/>", param);   
			
			//차트 조회
			ajaxCallAdmin("<c:url value='/admin/stat/open/getOpenStatCateChartAll.do'/>",formObj.serialize(),initializeChart);
			...
			mySheet.Down2Excel({FileName:'분류별_개방_현황.xls',SheetName:'mySheet'});
			break;
