...
{      
    ...
    with(mySheet){
    	...
    	var cfg = {SearchMode:2,Page:50,VScrollMode:1,MergeSheet:msPrevColumnMerge};                                
        SetConfig(cfg);  
        var headers = [                                             
        ...
        //코드값은 가운데정렬        
        var cols = [ 
					 {Type:"Seq",		SaveName:"seq",				Width:40,	Align:"Center",		Edit:false, ColMerge:false}
					,{Type:"Text",		SaveName:"cateNmTop",			Width:80,	Align:"Left",		Edit:false, ColMerge:true}
					,{Type:"Text",		SaveName:"cateNm",			Width:80,	Align:"Left",		Edit:false}
    ...
    mySheet.SetSumValue(0,"cateNm","합계"); 
...
function doAction(sAction)                                  
{
	...
	{          
		case "search":      //조회
			...
			mySheet.DoSearchPaging("<c:url value='/admin/stat/use/getUseStatCateSheetAll.do'/>", param);   
			
			//차트 조회
			ajaxCallAdmin("<c:url value='/admin/stat/use/getUseStatCateChartAll.do'/>",formObj.serialize(),initializeChart);
