...
<!--  
	...
	statUse -> validatestatUse 체크함
	resources/validator/*.* xml을 만들어서 사용
  -->
<%-- <validator:javascript formName="statUse" staticJavascript="false" xhtml="true" cdata="false"/> --%>
...
{      
	...
	var gridTitle = "NO";
		...
		gridTitle +="|"+"<spring:message code='labal.TOT_USE_CNT'/>";	// 전체 활용 수
		gridTitle +="|"+"<spring:message code='labal.S_USE_CNT'/>";		
		gridTitle +="|"+"<spring:message code='labal.C_USE_CNT'/>";		
		gridTitle +="|"+"<spring:message code='labal.M_USE_CNT'/>";		
		gridTitle +="|"+"<spring:message code='labal.F_USE_CNT'/>";		
		gridTitle +="|"+"<spring:message code='labal.L_USE_CNT'/>";		
		gridTitle +="|"+"<spring:message code='labal.A_USE_CNT'/>";		
		gridTitle +="|"+"<spring:message code='labal.V_USE_CNT'/>";		
		gridTitle +="|"+"<spring:message code='labal.EXCEL_CNT'/>";		
		gridTitle +="|"+"<spring:message code='labal.CSV_CNT'/>";		
		gridTitle +="|"+"<spring:message code='labal.JSON_CNT'/>";		
		gridTitle +="|"+"<spring:message code='labal.XML_CNT'/>";		
		gridTitle +="|"+"<spring:message code='labal.TXT_CNT'/>";		
		gridTitle +="|"+"<spring:message code='labal.FILE_USE_CNT'/>";	
		gridTitle +="|"+"<spring:message code='labal.LINK_USE_CNT'/>";	
		gridTitle +="|"+"<spring:message code='labal.API_USE_CNT'/>";	
		gridTitle +="|"+"<spring:message code='labal.APIS_USE_CNT'/>";	
		gridTitle +="|"+"<spring:message code='labal.CATALOG_USE_CNT'/>";
		gridTitle +="|"+"<spring:message code='labal.VISUAL_USE_CNT'/>";
    ...
    with(mySheet){
        ...
        var cols = [ 
					...
					,{Type:"Text",		SaveName:"dtNm",			Width:50,	Align:"Left",		Edit:false}
					,{Type:"AutoSum",		SaveName:"totUseCnt",			Width:50,	Align:"Right",		Edit:false}
					,{Type:"AutoSum",		SaveName:"sUseCnt",			Width:100,	Align:"Right",		Edit:false}
					...
					,{Type:"AutoSum",		SaveName:"catalogUseCnt",			Width:50,	Align:"Right",		Edit:false}
					,{Type:"AutoSum",		SaveName:"visualUseCnt",			Width:50,	Align:"Right",		Edit:false}
                   ];       
...
function doAction(sAction)                                  
{
	...
	{          
		case "search":      //조회
			...
			mySheet.DoSearchPaging("<c:url value='/admin/stat/use/getUseStatDtSheetAll.do'/>", param);   
...
// 	rytitNm = "건수";
// 	//X축 스타일                   
// 	initXStyleChart(obj,varColor, varColor, "분류");//chartObj, x색, y색, 이름
// 	// 왼쪽 Y축 스타일
...
//        	if(YcolNm[i] == "TOT_USE_CNT"){	// 전체 활용 수는 꺽은선 그래프로 표현
