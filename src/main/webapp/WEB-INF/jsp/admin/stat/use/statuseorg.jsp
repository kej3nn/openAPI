...
function doAction(sAction)                                  
{
	...
	{          
		case "search":      //조회
			...
			mySheet.DoSearchPaging("<c:url value='/admin/stat/use/getUseStatOrgSheetAll.do'/>", param);   
			
			//차트 조회
			ajaxCallAdmin("<c:url value='/admin/stat/use/getUseStatOrgChartAll.do'/>",formObj.serialize(),initializeChart);
...
function initializeChart(data){    
	...
	rytitNm = "건수";
	//X축 스타일                   
	initXStyleChart(obj,varColor, varColor, "기관");//chartObj, x색, y색, 이름
	// 왼쪽 Y축 스타일
...
function fnChartAddSeries(data,ix, slicedYN){
	...
	data.seriesResult = [
			{columnNm : "전체활용수"}, {columnNm : "Sheet"}, {columnNm : "Chart"}
			, {columnNm : "Map"}, {columnNm : "File"}, {columnNm : "Link"}
			, {columnNm : "OpenAPI"}, {columnNm : "시각화"}, {columnNm : "엑셀저장"}
			, {columnNm : "CSV저장"}, {columnNm : "JSON저장"}, {columnNm : "XML저장"}
			, {columnNm : "TXT저장"}, {columnNm : "File저장"}, {columnNm : "Link클릭"}
			, {columnNm : "API호출"}, {columnNm : "API샘플"}
			, {columnNm : "도내타기관"}, {columnNm : "시각화"}
	];
