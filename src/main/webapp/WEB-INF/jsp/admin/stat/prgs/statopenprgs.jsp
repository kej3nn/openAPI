...
<%
	...
	mode = EgovWebUtil.clearXSSMinimum(request.getParameter("mode"));
	}else{
	mode = "D";
	}
%>
...
{      
	...
	var gridTitle = "NO";
		...
		//gridTitle +="|"+"<spring:message code='labal.T_CNT'/>";		// TS Sheet 수
		...
		gridTitle +="|"+"<spring:message code='labal.V_CNT'/>";		// 시각화 수
		//gridTitle +="|"+"도내타기관";		// 멀티미디어 수
		//gridTitle +="|"+"<spring:message code='labal.VN_CNT'/>";		// 멀티미디어 수
    ...
    with(mySheet){
        ...
        var cols = [ 
					...
					,{Type:"Text",		SaveName:"yyyyMmDd",		Width:50,	Align:"Center",		Edit:false}
					,{Type:"Text",		SaveName:"srvCnt",			Width:50,	Align:"Right",		Edit:false, Format:"#,###"}
					,{Type:"Text",		SaveName:"sCnt",			Width:50,	Align:"Right",		Edit:false}
					,{Type:"Text",		SaveName:"cCnt",			Width:50,	Align:"Right",		Edit:false}
					,{Type:"Text",		SaveName:"mCnt",			Width:50,	Align:"Right",		Edit:false}
					,{Type:"Text",		SaveName:"fCnt",			Width:50,	Align:"Right",		Edit:false}
					,{Type:"Text",		SaveName:"lCnt",			Width:50,	Align:"Right",		Edit:false}
					,{Type:"Text",		SaveName:"aCnt",			Width:50,	Align:"Right",		Edit:false}		
					,{Type:"Text",		SaveName:"vCnt",			Width:50,	Align:"Right",		Edit:false}
                   ];       
...
function doAction(sAction)                                  
{
	...
	{          
		case "search":      //조회
			...
			mySheet.DoSearchPaging("<c:url value='/admin/stat/prgs/getOpenStatPrgsSheetAll.do'/>", param);   
			
			//차트 조회
			ajaxCallAdmin("<c:url value='/admin/stat/prgs/getOpenStatPrgsChartAll.do'/>",formObj.serialize(),initializeChart);
...
function fnChartAddSeries(data,ix, slicedYN){
	...
	data.seriesResult = [
			{columnNm : "서비스"}, {columnNm : "Sheet"}, {columnNm : "Chart"}
			, {columnNm : "Map"}, {columnNm : "File"}, {columnNm : "Link"}
			, {columnNm : "Open API"}, {columnNm : "시각화"}/*,{columnNm : "도내타기관"},{columnNm : "시각화"}*/
	];
	...
	for(var i=1; i < data.seriesResult.length ; i++){    
		var tp = [];
		var name = [];
