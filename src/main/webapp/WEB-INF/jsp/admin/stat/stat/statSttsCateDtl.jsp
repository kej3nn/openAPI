...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<div class="content" id="statInputDtl" style="clear: both; display: none;">
		<form id="sttsCate-dtl-form" name="sttsCate-dtl-form" method="post" action="#">
			...
			<table class="list01" style="position: relative;">
				...
				<tr>
					...
					<td colspan="2">
						...
						<button type="button" class="btn01" id="sttsCate_dup" name="sttsCate_dup">중복확인</button>
					</td>
					<td>※ 영문, 숫자 10자리 이내</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="2">
						...
						<button type="button" class="btn01" id="sttsCate_pop" name="sttsCate_pop">검색</button>
						<button type="button" class="btn01" id="sttsCate_init" name="sttsCate_init">상위 초기화</button>
					</td>
