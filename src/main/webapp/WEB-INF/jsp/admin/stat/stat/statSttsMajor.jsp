...
<script type="text/javascript" src="<c:url value="/js/admin/stat/statSttsMajor.js" />"></script>
...
<body onload="">
	<div class="wrap">
		...
		<div class="container">
			...
			<c:import  url="statSttsMajorDtl.jsp"/>
			...
			<div class="content">
				...
				<table class="list01">
					...
					<tr>
						<th>주요통계그룹</th>
						<td colspan="3">
							<select id="searchMajorStatCd" name="searchMajorStatCd" style="width : 180px">
							</select>
						</td>
					</tr>
					<tr>
						...
						<td colspan="3">
							<select name="searchGubun" value="">
								<option value="MAJOR_NM">한글 주요통계명</option>
								<option value="ENG_MAJOR_NM">영문 주요통계명</option>
								<option value="MAJOR_ID">주요통계ID</option>
							</select>
