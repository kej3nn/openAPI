...
<script type="text/javascript" src="<c:url value="/js/admin/stat/statStddItm.js" />"></script>
...
<body onload="">
	<div class="wrap">
		...
		<div class="container">
			...
			<c:import  url="statStddItmDtl.jsp"/>
				...
				<table class="list01">
					...
					<tr>
						...
						<td colspan="3">
							<select id="searchGubun" name="searchGubun">
								...
								<option value="ITM_ID">항목분류ID</option>
							</select>
					...
					<tr>
						...
						<td>
							...
							&nbsp;&nbsp;&nbsp;
							<input type="checkbox" name="chkTreeOpenClose" style="display: none;"/>
							<label for="chkTreeOpen" name="chkTreeOpenCloseLabel" style="display: none;">항목펼치기</label>
						</td>
					</tr>
				</table>		
