...
<body onload="">
				...
				<table class="list01">
					...
					<tr id="viewLocOptUsr-sect" style="display: none;">
						<td colspan="2">
							＊시계열 
							[
							<span id="optST-sect" style="vertical-align:baseline; color:#515151;"></span>
							]&nbsp;&nbsp;
							＊항목
							[
							<span id="optSI-sect" style="vertical-align:baseline; color:#515151;"></span>
							]&nbsp;&nbsp;
							＊분류 
							[
							<span id="optSC-sect" style="vertical-align:baseline; color:#515151;"></span>
							]
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<button type="button" class="btn01L" title="항목선택" id="itmArticle">
								<c:choose>            
							...
							<button type="button" class="btn01L" title="분류선택" id="clsArticle">
								<c:choose>            
									<c:when test="${viewLang eq 'E'}">
										CATEGORY SELECT▼
									</c:when>
				...
				<div id="cmmt-sect" style="border :1px solid; padding: 10px; background-color:rgba(235, 238, 241, 0.35); display: none;">
					...
					<c:forEach var="cmmt" items="${cmmtList}" varStatus="status">
						<c:if test="${cmmt.cmmtGubun ne 'TBL' }">
							<tr>
								<td style="width:20%">${cmmt.cmmtIdtfr}</td>
								<td style="width:80%">${cmmt.cmmtCont }</td>
							<tr>
						</tr>
						</c:if>
					</c:forEach>
	...
	<div class="wrap-popup">
		<div id="itmTreePop"  class="popup" style="width:300px;height:320px;position:absolute;top:397px;left:60px;z-index:20;display:none;">
			<h3>항목 선택</h3>
		...
		<div id="clsTreePop"  class="popup" style="width:300px;height:320px;position:absolute;top:397px;left:165px;z-index:20;display:none;">
			<h3>분류 선택</h3>
			<a href="javascript:;" class="popup_close" id="close">X</a>
			<div style="padding:0 15px;min-width:270px;">
				<div class="item-select">
