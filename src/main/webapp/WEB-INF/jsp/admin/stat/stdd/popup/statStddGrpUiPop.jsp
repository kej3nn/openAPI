...
function loadPage() {
    ...
    with(sheet){
       ...
       var cols = [          
					...
					,{Type:"Text",		SaveName:"uiNm",			Width:120,	Align:"Left",		Edit:false}
...
function doAction(sAction) {
	...
	switch(sAction) {
		case "search":      //조회   
			...
			sheet.DoSearchPaging(com.wise.help.url("/admin/stat/statStddGrpUiList.do"), param);
			break;
	}
}
...
function sheet_OnDblClick(row, col, value, cellx, celly) {
	...
	arrayValue = {
			grpUiId : sheet.GetCellValue(row, "uiId"), 
    		grpUiNm : sheet.GetCellValue(row, "uiNm"), 
	}
