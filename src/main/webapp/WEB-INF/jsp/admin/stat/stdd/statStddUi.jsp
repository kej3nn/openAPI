...
<script type="text/javascript" src="<c:url value="/js/admin/stat/statStddUi.js" />"></script>
...
<body onload="">
	<div class="wrap">
		...
		<div class="container">
			...
			<c:import  url="statStddUiDtl.jsp"/>
			...
			<div class="content">
				...
				<table class="list01">
					...
					<tr>
						<th>단위유형</th>
						<td colspan="3">
							<select id="searchUityCd" name="searchUityCd" style="width : 180px">
							</select>
						</td>
					</tr>
					<tr>
						...
						<td colspan="3">
							<select id="searchGubun" name="searchGubun">
								<option value="UI_NM">표준항목명</option>
								<option value="ENG_UI_NM">영문표준항목명</option>
								<option value="UI_ID">단위ID</option>
							</select>
