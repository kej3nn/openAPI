...
<script type="text/javascript" src="<c:url value="/js/admin/opendatamng/openApiLinkageMng.js" />"></script>
...
<body onload="">
	<div class="wrap">
		...
		<div class="container">
			...
			<c:import  url="openApiLinkageMngDtl.jsp"/>
			...
			<div class="content">
				...
				<table class="list01">
					...
					<tr>
						...
						<td colspan="3">
							<select name="searchGubun" value="">
								...
								<option value="DS_ID">대상 데이터셋</option>
								<option value="API_URL">호출URL</option>
							</select>
					...
					<tr>
						<th>실행모드</th>
						<td>
							<input type="radio" value="" name="runMode" id="runModeAll" checked="checked"><label for="runModeAll">전체</label></input>&nbsp;&nbsp;
							<input type="radio" value="Y" name="runMode" id="runModeY"><label for="runModeY">실행</label></input>&nbsp;&nbsp;
