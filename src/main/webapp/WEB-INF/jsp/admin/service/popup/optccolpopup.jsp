						...
						<colgroup>
							...
							<tr>                            
								...
								<td>
									...
									<label for="filtY">사용</label>
									<input type="radio" name="filtYn" id="filtN" value="N"/>
									<label for="filtN">미사용</label>
							...
							<tr id="dateTr" style="display:none">
								<th>&nbsp;&nbsp;ㄴ 최대기간</th>
								<td>제한 <input type="text" size="4" name="filtMaxDay" maxlength="4" value="${resultList.filtMaxDay}"/> 일</td>
							</tr>
							...
							<tr id="popupTr" style="display:none">
								...
								<td>
									...
									<select name="filtTblCd">
										<option value="">대상테이블</option>
										<c:forEach var="code" items="${codeMap.tblCd}" varStatus="status">
												<option value="${code.ditcCd}">${code.ditcNm}</option>
										</c:forEach>
									</select>
									<input type="text" size="10" id="filtDefault2" name="filtDefault2" value="${resultList.filtDefault2}" maxlength="100"/>
									<input type="checkbox" name="filtNeed2" id="filtNeed2" value="Y"/>                  
									<label for="filtNeed2">필수</label>
								</td>
							</tr>   
						</table>                   
