var webFilterServerAddress = "wfptt.assembly.go.kr";
//var webFilterServerAddress = "211.46.92.124";
...
function submitWebFilter( formName ){
	try{
		...
		if(WFdebug) alert("3. �׼�URL ���� : " + com.wise.help.XSSfilter(act.value));
		...
		if(WFdebug) alert("6. �׼�URL �����η� ���� : " + com.wise.help.XSSfilter(act.value));
		...
		if(denyParamCheck(act, targetForm) && denyActionCheck(act, targetForm)){
			...
			if(WFdebug) alert("7. �������� ���� : " + com.wise.help.XSSfilter(WFprotocol));
			...
			if(WFdebug) alert("8. �׼�URL �����ͷ� ���� ���� : " + com.wise.help.XSSfilter(act.value));

			WFsubmitRestore();

			targetForm.submit();

			if(brCheck.indexOf("ie") >  -1 || brCheck.indexOf("firefox") > -1 || brCheck.indexOf("safari") > -1){
				restoreForm(formName);
			}
