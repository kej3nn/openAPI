...
/**
 * @license Hcharts JS v2.2.0 (2012-02-16)
...
(function (Hcharts) { // encapsulate
	var UNDEFINED,
		...
		PX = 'px',
		css = Hcharts.css,
		CanVGRenderer = Hcharts.CanVGRenderer,
		SVGRenderer = Hcharts.SVGRenderer,
		extend = Hcharts.extend,
		merge = Hcharts.merge,
		addEvent = Hcharts.addEvent,
		placeBox = Hcharts.placeBox,
		createElement = Hcharts.createElement,
		discardElement = Hcharts.discardElement;
