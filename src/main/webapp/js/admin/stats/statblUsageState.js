/*
 * @(#)statblUsageState.js 1.0 2018/09/05
 */

/**
 * 관리자 통계표별 활용현황 스크립트 파일이다
 *
 * @author 김정호
...
function doAction(sAction) {
	...
	switch(sAction) {                       
		case "search":
			...
			sheet.DoSearchPaging(com.wise.help.url("/admin/stat/statblUsageStateList.do"), { Param : $("form[name=statOpen]").serialize() });
			break;
		case "excel":
...
function loadSheet() {
	...
	with(sheet){
	    ...
	    var cols = [
	                ...
	                ,{Type:"Text",		SaveName:"statblNm",	Width:180,	Align:"Left",		Edit:false}
	                ,{Type:"Text",		SaveName:"cateFullNm",	Width:230,	Align:"Left",		Edit:false}
					,{Type:"AutoSum",	SaveName:"useCnt",		Width:110,	Align:"Center",		Edit:false,	Format : "Integer"}
					,{Type:"AutoSum",	SaveName:"downCnt",		Width:100,	Align:"Center",		Edit:false,	Format : "Integer"}
					,{Type:"AutoSum",	SaveName:"excelCnt",	Width:100,	Align:"Center",		Edit:false,	Format : "Integer"}
					,{Type:"AutoSum",	SaveName:"csvCnt",		Width:100,	Align:"Center",		Edit:false,	Format : "Integer"}
					,{Type:"AutoSum",	SaveName:"jsonCnt",		Width:100,	Align:"Center",		Edit:false,	Format : "Integer"}
					,{Type:"AutoSum",	SaveName:"xmlCnt",		Width:100,	Align:"Center",		Edit:false,	Format : "Integer"}
					,{Type:"AutoSum",	SaveName:"txtCnt",		Width:100,	Align:"Center",		Edit:false,	Format : "Integer"}
					,{Type:"AutoSum",	SaveName:"hwpCnt",		Width:100,	Align:"Center",		Edit:false,	Format : "Integer"}
				];
