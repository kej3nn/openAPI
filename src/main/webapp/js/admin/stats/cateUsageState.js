/*
 * @(#)statUsageState.js 1.0 2018/09/05
 */

/**
 * 관리자 분류별 활용현황 스크립트 파일이다
 *
 * @author 김정호
...
function doAction(sAction) {
	...
	switch(sAction) {                       
		case "search":
			...
			sheet.DoSearchPaging(com.wise.help.url("/admin/stat/cateUsageStateList.do"), { Param : $("form[name=statOpen]").serialize() });
			break;
		case "excel":
...
function loadSheet() {
	...
	with(sheet){
	    ...
	    var cols = [
	                ...
	                ,{Type:"Text",		SaveName:"cateNm",		Width:230,	Align:"Center",		Edit:false} 
					,{Type:"Combo",		SaveName:"useIpTag",	Width:100,	Align:"Center",		Edit:false}
