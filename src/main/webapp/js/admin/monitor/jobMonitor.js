...
function doActionMain(sAction) {
	...
	switch(sAction) {                       
		case "search":
			...
			mainSheet.DoSearchPaging(com.wise.help.url("/admin/monitor/jobMonitorListPaging.do"), param);
			break;
		case "excel":
...
function loadMainSheet() {
	...
	var gridTitle = "NO|처리번호|JOB명|원천객체명|대상객체명|처리건수|처리 메세지|처리구분|처리일시";
	...
	with(mainSheet){
	    ...
	    var cols = [
	                ...
	                ,{Type:"Text",		SaveName:"jobNm",			Width:150,	Align:"Center",	Edit:false}
