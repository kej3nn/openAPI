/*
 * @(#)statAcesGG.js 1.0 2020/11/04
 */

/**
 * 관리자 구글 사이트 분석 현황 - 접속자수 스크립트 파일이다
 *
 * @author WISE
...
function doAction(sAction) {
	...
	switch(sAction) {                       
		case "search":
			...
			sheet.DoSearchPaging(com.wise.help.url("/admin/gaapi/selectStatAcesGGList.do"), param);
			break;
		case "excel":
...
function loadSheet() {
	...
	with(sheet){
	    ...
	    var cols = [
					...
					,{Type:"Text",	    SaveName:"lvRto",	    		Width:100,	Align:"Center",		Edit:false}
					,{Type:"Text",	    SaveName:"ssenAvgTm",	    	Width:100,	Align:"Center",		Edit:false}
