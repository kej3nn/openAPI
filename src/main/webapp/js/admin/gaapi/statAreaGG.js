/*
 * @(#)statAreaGG 1.0 2020/11/04
 */

/**
 * 관리자 구글 사이트 분석 현황 - 지역현황 스크립트 파일이다
 *
 * @author WISE
...
function doAction(sAction) {
	...
	switch(sAction) {                       
		case "search":
			...
			sheet.DoSearchPaging(com.wise.help.url("/admin/gaapi/selectStatAreaGGList.do"), param);
			break;
		case "excel":
...
function loadSheet() {
	...
	with(sheet){
	    ...
	    var cols = [
	                ...
	                ,{Type:"Text",	    SaveName:"natNm",				Width:100,	Align:"Left",		Edit:false}
