/*
 * @(#)statPageGG 1.0 2020/11/04
 */

/**
 * 관리자 구글 사이트 분석 현황 - 페이지뷰 스크립트 파일이다
 *
 * @author WISE
...
function doAction(sAction) {
	...
	switch(sAction) {                       
		case "search":
			...
			sheet.DoSearchPaging(com.wise.help.url("/admin/gaapi/selectStatPageGGList.do"), param);
			break;
		case "excel":
...
function loadSheet() {
	...
	with(sheet){
	    ...
	    var cols = [
					...
					,{Type:"Text",	    SaveName:"menuFullnm",			Width:100,	Align:"Left",		Edit:false}
					,{Type:"Text",	    SaveName:"pgvwCnt",				Width:100,	Align:"Center",		Edit:false}
					,{Type:"Text",	    SaveName:"pgvwRto",	    		Width:100,	Align:"Center",		Edit:false}
