...
function selectTreeMapData() {
	doAjax({
		url: "/portal/assm/chart/selectTreeMapData.do",
...
function selectColumnReeleData() {
	doAjax({
		url: "/portal/assm/chart/selectColumnReeleData.do",
		callback: function(res) {
			var data = res.data;
...
function selectPieData() {
	doAjax({
		url: "/portal/assm/chart/selectPieData.do",
		callback: function(res) {
			var data = res.data;
			loadPieChart(data);
		}
...
function selectColumnAgeData() {
	doAjax({
		url: "/portal/assm/chart/selectColumnAgeData.do",
		callback: function(res) {
			var data = res.data;
